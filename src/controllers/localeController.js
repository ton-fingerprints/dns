...
const INDEX_LOCALES = {
  ru: {
    ...
    address: "Адрес",
    adnl: "ADNL адрес",
    testnet_badge_message:
      "Внимание, это тестовая сеть! Не отправляйте настоящие TON. Тестовые домены могут быть удалены.",
    open_auction: "Зарегистрировать домены .fingerprints.ton",
    start_input_placeholder: "Введите домен",
    start_splash:
      "Зарегистрируйте короткие читаемые имена для кошельков, смарт-контрактов и веб-сайтов.",
    ...
    bet_price: "Ставка",
    start_bid:
      "Домен можно приобрести на открытом аукционе. Сделайте первую ставку, чтобы начать аукцион.",
    ...
    pay_attention:
      'Используйте только <a class="unbreak" href="https://ton.org/wallets?filterBy=wallets_non_custodial" target="_blank">некастодиальные</a> кошельки для&nbsp;оплаты.',
    sent_to: "Адрес",
    message: "Комментарий",
    ...
    invalid_chars:
      "В домене можно использовать английские символы (a-z), цифры (0-9) и дефис (-). Дефис не может находиться в начале и конце.",
    not_owner: "Вы не владелец домена",
    login_extention:
      "Войдите и авторизуйтесь в расширении TON Wallet для редактирования домена",
    invalid_address: "Неправильный адрес",
    invalid_adnl_address: "Неправильный ADNL адрес",
    install_extension:
      "Установите расширение TON Wallet для управления доменом",
    auction: "Аукцион",
    free: "Свободен",
    busy: "Занят",
    ...
    use_other_payments:
      'Другие способы оплаты <svg class="arrow icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
    ...
    wallet_modal_first_description:
      "Выберете кошелёк из списка, чтобы начать работу",
    ...
    wallet_modal_second_description_1:
      "Отсканируйте QR-код с помощью мобильного телефона или",
    ...
    payment_loading_description:
      "Проверяем оплату. Это может занять некоторое время.",
    payment_success_header: "Оплата прошла успешно",
    payment_success_description:
      "Если ваша ставка будет перебита, деньги вернутся на кошелек.",
    payment_failure_rejection_header: "Транзакция отклоненна",
    payment_failure_rejection_description:
      "Вы отклонили транзакцию. Пожалуйста, повторите попытку.",
    ...
    wallet_connect_mytonwallet_unknown_error:
      "Пожалуйста проверьте свой кошелек. Попробуйте сменить сеть в настройках кошелька.",
    my_domains: "Мои домены",
    my_expiring_domains_caption:
      "В этот лист включены только домены, истекающие в следующие 360 дней",
    ...
    manage_domain_unavailable:
      "Что-то пошло не так. Пожалуйста, повторите попытку.",
    manage_domain_payment_caption: "Редактирование настроек домена",
    manage_domain_payment_explanation:
      "Совершите оплату для редактирования настроек домена.",
  ...
  en: {
    ...
    start_splash:
      "Give crypto wallets, smart contracts or websites short readable names.",
    error_length:
      "The domain name must be at least 4 characters and no more than 126 characters.",
    subdomains_not_allowed: "Subdomains are not allowed.",
    invalid_chars:
      "English letters (a-z), numbers (0-9), and hyphens (-) are allowed. A hyphen cannot be at the beginning or the end.",
    not_owner: "You are not the owner of this domain.",
    login_extention:
      "Open and log in to the TON Wallet extension for domain management.",
    invalid_address: "The address is invalid.",
    invalid_adnl_address: "The ADNL address is invalid.",
    install_extension:
      "Please install the TON Wallet extension to edit the domain",
    auction: "On auction",
    free: "Available",
    busy: "Taken",
    ...
    payment_success_description:
      "If your bid is outbid, the money will be returned to the wallet.",
    payment_failure_rejection_header: "Payment rejected",
    payment_failure_rejection_description:
      "You have rejected the payment. Please try again.",
    payment_failure_error_header: "Something went wrong",
    payment_failure_error_description:
      "Please reload the page or try again later.",
    payment_done_button: "Done",
    wallet_connect_mytonwallet_unknown_error:
      "Please check your wallet. Try to switch network in the wallet settings.",
    ...
    manage_domain_payment_explanation:
      "Make a payment to change domain settings.",
...
const ABOUT_LOCALES = {
  ru: {
    ...
    rules_for_ton_domain_names: "Правила доменов .fingerprints.ton",
    rules_for_ton_domain_names_p1:
      'Домен в зоне ".fingerprints.ton" должен быть не менее 4 символов и не более 126 символов. Регистрация доменов менее 4 символов недоступна, чтобы не вносить дополнительную путаницу со стандартными интернет-доменами вроде "com", "org", "gov" и т.п.',
    ...
    claim_your_ton_domain_p9:
      '4. Теперь откройте ваш домен на <a target="_blank" href="https://dns.fingerprints.space/">TON Fingerprints DNS</a> и нажмите кнопку "Редактировать".',
  ...
  en: {
    ...
    rules_for_ton_domain_names_p1:
      "The “.fingerprints.ton” domain name must be at least 4 characters and no more than 126 characters. Registering a domain name with fewer than 4 characters is unavailable to avoid confusion with well-known internet domain names, such as “com”, “org”, “gov”, etc.",
    rules_for_ton_domain_names_p2:
    ...
    claim_your_ton_domain_p1:
      'Go to <a target="_blank" href="https://dns.fingerprints.space/">TON Fingerprints DNS</a> and enter your domain. If the auction has closed, you’ll see this:',
    claim_your_ton_domain_p2:
    ...
    claim_your_ton_domain_p9:
      '4. Now open your domain on <a target="_blank" href="https://dns.fingerprints.space/">TON Fingerprints DNS</a> and click on “Manage your domain”.',
    claim_your_ton_domain_p10:
